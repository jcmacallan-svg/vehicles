...
function renderQuestion() {
  ...
  const imgSrc = q.asset ? `images/${state.service}/${q.asset}.jpg` : 'images/missing.jpg';
  ...
  return `
    ...
    <main class="wrap">
      <section class="card">
        ...
        <div class="media">
          <img id="mainImage" class="zoomable" src="${imgSrc}" alt="${q.answer || 'vehicle'}" onerror="this.onerror=null;this.src='images/missing.jpg';" />
        </div>
